      ...
      <div className="fixed inset-0 overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
          <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full">
            <DialogPanel
              transition
              className="pointer-events-auto relative w-64 transform transition duration-500 ease-in-out data-closed:-translate-x-full"
            >
              <div className="flex h-full flex-col overflow-y-scroll dark:bg-gray-800 py-4 shadow-xl">
