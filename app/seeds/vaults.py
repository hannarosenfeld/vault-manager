...
def seed_vaults():
    v1 = Vault(
        customer_id=2, field_id=25, position='TOP', vault_id='144')
    v2 = Vault(
        customer_id=3, field_id=25, position='MIDDLE', vault_id='266')
    v3 = Vault(
        customer_id=1, field_id=25, position='BOTTOM', vault_id='176')
