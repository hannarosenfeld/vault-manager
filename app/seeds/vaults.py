...
def seed_vaults():
    v1 = Vault(
        customer_id=2, field_id=25, field_name="C1", position='T', vault_id='144')
    v2 = Vault(
        customer_id=3, field_id=25, field_name="C1", position='M', vault_id='266')
    v3 = Vault(
        customer_id=1, field_id=25, field_name="C1", position='B', vault_id='176')
